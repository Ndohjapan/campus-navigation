...
(function($) {
	...
	function cP() {
		...
		h.c.hF = h.d("i", {
			a : "class",
			v : "fas fa-music playerHeadPhone"
		},undefined,undefined);
	...
	function uT() {
		h.upt = setInterval(function() {
			...
			if(h.c.vr.value == 0){
				h.c.vF.setAttribute("class","fas fa-volume-off");
			}else if(h.c.vr.value <= 50){
				h.c.vF.setAttribute("class","fas fa-volume-down");
			}else if(h.c.vr.value >= 50){
				h.c.vF.setAttribute("class","fas fa-volume-up");
			}
			}
		}, 100);
	}
	...
	var pL = function() {
			if(h.c.a.duration > 0){
			if(this.children[0].getAttribute("class") == "fas fa-play"){
				h.c.a.play();
				this.setAttribute("class", "pause");
				this.children[0].setAttribute("class", "fas fa-pause");
				uT();
			}else if(this.children[0].getAttribute("class") == "fas fa-pause"){
				h.c.a.pause();
				this.setAttribute("class", "play");
				this.children[0].setAttribute("class", "fas fa-play");
				clearInterval(h.upt);
			}
			}
	}
	...
	var vlck = function(e){
			if(h.c.a.volume != 0){
				...
				h.c.vrpre = h.c.vr.value;
				this.setAttribute("class","fas fa-volume-off");
				h.c.a.volume = 0;
				h.c.vr.value = 0;
	...
	function rpa() {
			h.c.ply.children[0].setAttribute("class", "fas fa-play");
